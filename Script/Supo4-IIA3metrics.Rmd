...
output: pdf_document
header-includes: 
  - \usepackage{amsmath, tcolorbox, dashrule, booktabs}
...
#contour plot
contour(x,y,z, main="Contour", axes=FALSE)
...
\]
So we transform equation \ref{eq:SQ1} on page \pageref{eq:SQ1} by dividing it with theses known variances
\[
