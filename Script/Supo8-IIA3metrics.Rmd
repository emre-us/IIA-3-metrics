...
\[
\rho_k = \frac{\gamma_k}{\gamma_0} = \frac{Cov({DWinTime}_t\ ,\ {DWinTime}_{t-k})}{\sqrt{Var({DWinTime}_t)\ ,\ Var(DWinTime_{t-k})}} = \frac{Cov({DWinTime}_t\ ,\ {DWinTime}_{t-k})}{Var({DWinTime}_t)}
\]
