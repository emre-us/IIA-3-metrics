...
\[
Var(b^*) = Var\left( \frac{y_T-y_1}{T-1} \right) = \left( \frac{1}{T-1}  \right)^2 Var(y_T-y_1) = \frac{2\sigma_e^2}{(1-T)^2}
\]
...
\sum_{t=1}^n (t-\bar{t})^2 
    &= \sum_{t=1}^T \left( t-\frac{T(T+1)}{2T} \right)^2 \ \ \ \ \ \text{ since } \sum_{t=1}^T t = \frac{T(T+1)}{2} \\[4pt]
    &= \frac{1}{4}\sum_{t=1}^T\Big( 2t - (T+1) \Big)^2 \\[4pt]
    &= \frac{1}{4}\sum_{t=1}^T\Big( 4t^2 + (T+1)^2 - 4t(T+1) \Big) \\[4pt]
    &= \frac{1}{4}\left( 4\sum_{t=1}^Tt^2 + (T+1)^2 - 4\sum_{t=1}^Tt(T+1) \right) \\[4pt]
    &= \frac{1}{4}\left( 4\sum_{t=1}^Tt^2 + (T+1)^2 - 4\frac{T(T+1)}{2}(T+1) \right) \\[4pt]
    &= \frac{1}{4}\left( 4\sum_{t=1}^Tt^2 + (T+1)^2 - 2T(T+1)^2 \right) \\[4pt]
    &= \frac{1}{4}\left( 4\frac{T(T+1)(2T+1)}{6} + (T+1)^2 - 2T(T+1)^2  \right) \ \ \ \ \ \text{ since } \sum_{t=1}^T t^2 = \frac{T(T+1)(2T+1)}{6} \\[4pt]
    &= \left( \frac{T(T+1)(2T+1)}{6} + \frac{(T+1)^2 - 2T(T+1)^2}{4}  \right) \\[4pt] 
    &= \left( \frac{2T(T+1)(2T+1) + 3(T+1)^2 - 6T(T+1)^2}{12}  \right) \\[4pt]
    &= \left( \frac{-2T^3 - 3T^2 + 2T +3}{12} \right) \\[4pt]
    &= \left( \frac{(T+1)(1-T)(2T+3)}{12} \right)
\end{align*}

So, plugging this back in to the variance expression:
\[
Var(\hat{\beta}) = \frac{12\sigma_e^2}{(T+1)(1-T)(2T+3)}
\]
Thus, $Var(\hat{\beta}) < Var(b^*)$. The two can be equal if $\frac{2\sigma_e^2}{(1-T)^2} = \frac{12\sigma_e^2}{(t+1)(t-1)(-2t-3)}$ which can happen only if
...
So $T= \dfrac{\sqrt{5}-3}{2}$ since $T=\frac{-3 \pm \sqrt{3^2-4(1)(1)}}{2\times 1}$
