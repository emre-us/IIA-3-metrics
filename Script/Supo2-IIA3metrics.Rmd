...
\sum_{t=1}^T (t-\bar{t})^2
  ...
  &= \sum_{t=1}^Tt^2 - \bar{t}\sum_{t=1}^Tt \\[6pt]
  &= \frac{T(T+1)(2T+1)}{6} - \left( \frac{T(T+1)}{2T}  \right)\left( \frac{T(T+1)}{2} \right)  \ \ \ \ \ \text{ since } \sum t^2 = \frac{T(T+1)(2T+1)}{6} \text{ and } \sum t = \frac{T(T+1)}{2} \\[6pt]
