...
Now recall that the standard error of $\beta$ was:
\[
\mathit{se}(\hat{\beta}) = \sqrt{ \dfrac{ \hat{\sigma}_{\epsilon}^2 }{ \displaystyle\sum_{t=1}^n (y_t-\bar{y})^2 } } = \sqrt{ \dfrac{ \dfrac{\displaystyle\sum_{t=1}^n e_t^2}{n-2} }{ \displaystyle\sum_{t=1}^n (y_t-\bar{y})^2 } } = \sqrt{ \dfrac{ \displaystyle\sum_{t=1}^n e_t^2 }{ (n-2)\displaystyle\sum_{t=1}^n (y_t-\bar{y})^2 } } 
\]
Since
\[
R^2 = 1 - \dfrac{ \displaystyle\sum_{t=1}^n e_t^2 }{\displaystyle\sum_{t=1}^n (c_t-\bar{c})^2 }
\]
the standard error of $beta$ becomes:
\[
\mathit{se}(\hat{\beta}) = \sqrt{ \dfrac{ 1-\bigg{(}R^2\displaystyle\sum_{t=1}^n (c_t-\bar{c})^2 \bigg{)}}{ (n-2)\displaystyle\sum_{t=1}^n (y_t-\bar{y})^2 } }
\]
since $R^2$ is the estimate of $\rho$, or $\hat{\rho}$.

The test statistic for $\rho$ is therefore:
\[
t_{\hat{\rho}} = t_{\hat{\beta}} = \frac{\hat{\rho} - \rho^0}{\sqrt{ (n-2)(1-\hat{\rho}^2) }} = \frac{0.9981586}{\sqrt{54 \times (1-0.9981586^2)}} = 120.9226.
\]
